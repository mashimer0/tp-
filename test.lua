...
-- Buttons
------------------------------------------------
local WallBtn = createButton("壁抜け : OFF",35,Color3.fromRGB(255,80,80))
local SaveBtn = createButton("セーブ",72,Color3.fromRGB(70,120,255))
local TpBtn = createButton("TP",109,Color3.fromRGB(170,80,255))

local JumpBtn = createButton("無限ジャンプ : OFF",35,Color3.fromRGB(170,120,255))
local FriendBtn = createButton("フレンド申請🤝",72,Color3.fromRGB(255,170,0))
...
PageBtn.Position = UDim2.new(1,-85,1,-38)
PageBtn.Position = UDim2.new(1,-85,1,-28)
